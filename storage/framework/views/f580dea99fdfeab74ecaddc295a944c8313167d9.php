  ...
  <div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
      <div class="ibox-content">
        ...
        <?php endif; ?>
        <form role="form" method="post" action="<?php echo e(url('frases/'. $frase->id )); ?>">
            <?php echo e(csrf_field()); ?>

            <input name="_method" type="hidden" value="PUT">
            <div class="form-group">
              <label>Nombre</label>
              <input type="text" placeholder="Nombre" class="form-control" name="nombre" value="<?php echo e($frase->nombre); ?>">
            </div>
            <div class="form-group">
