...
<?php $__env->startSection('breadcrumb'); ?>
  <li class="active">Control Diario</li>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        ...
        <form role="form" method="get" action="<?php echo e(url('/reportes/control-diario')); ?>">
            <?php echo e(csrf_field()); ?>

            <legend>Busqueda por fecha</legend>


             <div class=" col-md-3 form-group" id="data_4">
                <label class="font-normal">D&iacute;a:</label>
                <div class="input-group date">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" name="dia">
                </div>
            </div>   

            <div class="col-md-3 form-group" id="data_3">
