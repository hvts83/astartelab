      ...
      <div class="ibox-content">
        ...
        <form role="form" method="post" action="<?php echo e(url('doctores/'. $doctor->id )); ?>">
            ...
            <div class="form-group">
              ...
              <textarea name='direccion' class="form-control"><?php echo e($doctor->direccion); ?> </textarea>
            </div>
            <div class="div-btn">
                <button class="btn btn-primary m-t-n-xs pull-right" type="submit"><strong>Guardar</strong></button>
                <a href="<?php echo e(url('doctores/')); ?>" class="btn m-t-n-xs pull-right"><strong>Cancelar</strong></a>
            </div>
        </form>
      </div>
  </div>
