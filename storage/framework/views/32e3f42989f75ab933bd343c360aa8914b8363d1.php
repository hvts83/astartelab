            ...
            <div class="row">
                ...
                <div class="form-group" id="edad">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><input type="text" name="edad" class="form-control" value="<?php echo e($paciente->edad); ?>">
                    </div>
                </div>
            </div>
            <div class="col-lg-6"> 
                <div class="form-group" id="meses">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><input type="text" name="meses" class="form-control" value="<?php echo e($paciente->meses); ?>">
                    </div>
                </div>
            </div>
            </div>
