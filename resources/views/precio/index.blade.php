...
<div class="wrapper wrapper-content animated fadeInRight">
  <div class="row">
    <div class="ibox-content">
      ...
      <div class="div-btn">
          <a href="{{ url('/precios/create/B') }}" class="btn btn-primary pull-right">Nuevo Precio de Biopsia</a>
          <a href="{{ url('/precios/create/C') }}" class="btn btn-primary pull-right">Nuevo Precio de Citología</a>
      </div>
    </div>
  </div>
</div>
